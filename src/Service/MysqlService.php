...
/**
 * Service extendng \mysqli class.
 */
class MysqlService extends \mysqli
{
	/**
	...
	public function __construct(array $connectionData)
	{
		...
		if(mysqli_connect_errno()) {
			throw new \App\Exception\DatabaseConnectionException(mysqli_connect_error(), mysqli_connect_errno());
		}
